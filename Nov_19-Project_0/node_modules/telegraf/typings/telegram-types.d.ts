...
export declare type NewInvoiceParameters = MakeExtra<'sendInvoice', 'disable_notification' | 'reply_to_message_id' | 'allow_sending_without_reply' | 'reply_markup' | 'message_thread_id'>;
...
export declare type ExtraForwardMessage = MakeExtra<'forwardMessage', 'from_chat_id' | 'message_id'>;
...
export declare type ExtraCreateForumTopic = MakeExtra<'createForumTopic', 'name'>;
export declare type ExtraEditForumTopic = MakeExtra<'editForumTopic', 'message_thread_id'>;
export declare type MediaGroup = readonly (InputMediaPhoto | InputMediaVideo)[] | readonly InputMediaAudio[] | readonly InputMediaDocument[];
